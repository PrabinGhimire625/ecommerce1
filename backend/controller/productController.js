...
export const addProduct = async (req, res) => {
  const userId=req.user.id //from authenticationmiddleware  req.user=userData
...
export const getAllProducts=async(req,res)=>{
  ...
  res.status(200).json({message:"All product fetch successfully",data:product})
}
...
export const getSingleProduct=async(req,res)=>{
  ...
  res.status(200).json({message:"Single product fetched successfully!",data:product})
}
